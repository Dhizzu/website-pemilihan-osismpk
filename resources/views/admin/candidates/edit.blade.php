                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.candidates.update', $candidate) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="candidate_number" id="candidate_number" value="{{ old('candidate_number', $candidate->candidate_number) }}" required
                                class="mt-1 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="position" id="position" required
                                ...
                                <option value="OSIS" {{ old('position', $candidate->position) == 'OSIS' ? 'selected' : '' }}>OSIS</option>
                                <option value="MPK" {{ old('position', $candidate->position) == 'MPK' ? 'selected' : '' }}>MPK</option>
                            </select>
                            @error('position')
                                <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        @if($candidate->photo_path)
                            <div class="mb-4">
                                ...
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $candidate->photo_path) }}" alt="{{ $candidate->name }}" class="h-32 w-32 rounded-lg object-cover">
                                </div>
                            </div>
                        @endif
                        ...
                        <!-- New Photo -->
                        <div class="mb-4">
                            <label for="photo" class="block text-sm font-medium text-gray-300">New Photo (optional)</label>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="visi" id="visi" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('visi', $candidate->visi) }}</textarea>
                            @error('visi')
                                <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="misi" id="misi" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('misi', $candidate->misi) }}</textarea>
                            @error('misi')
                                <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
